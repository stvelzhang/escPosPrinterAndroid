...
public abstract class BluetoothBasePrintActivity extends AppCompatActivity {
     ...
     * Callback after successful Bluetooth connection,
     * this method is executed in the child thread and can perform time-consuming operations
     */
     ...
     * Check the Bluetooth status, if it is turned on, find the bound device
     *
     * @return
     */
    ...
    class ConnectBluetoothTask extends AsyncTask<BluetoothDevice, Integer, BluetoothSocket> {
        ...
        protected void onPreExecute() {
            showProgressDialog (getString (R.string.dialog_01));
            super.onPreExecute ();
        }
        ...
        protected void onPostExecute(BluetoothSocket socket) {
            ...
            if (socket == null || !socket.isConnected ()) {
                toast (getString (R.string.total_06));
            } else {
                toast (getString (R.string.total_07));
            }
    ...
    /**
     * 监听蓝牙状态变化的系统广播
     * System broadcast to monitor Bluetooth status changes
     */
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (state) {
                case BluetoothAdapter.STATE_TURNING_ON:
                    toast (getString (R.string.total_08));
                    break;
                case BluetoothAdapter.STATE_TURNING_OFF:
                    toast (getString (R.string.total_09));
                    break;
            }
