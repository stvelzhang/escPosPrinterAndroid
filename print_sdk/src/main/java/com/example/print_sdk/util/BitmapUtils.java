...
public class BitmapUtils {
    ...
    public static Bitmap createBarcode(Context context, String contents, int desiredWidth, int desiredHeight, boolean displayCode, int barType) {
        ...
        if (displayCode) {
            ...
            Bitmap codeBitmap=createCodeBitmap (context,contents, desiredWidth, desiredHeight);
    ...
    public static Bitmap createCodeBitmap(Context context, String contents, int width, int height) {
     ...
     * @param bitmapOrg
     */
    public static Bitmap compressPic(Bitmap bitmapOrg,int widthPixel,int heightPixel) {
        // 获取这个图片的宽和高
        int width=bitmapOrg.getWidth ();
        int height=bitmapOrg.getHeight ();
        // 定义预转换成的图片的宽度和高度
        int newWidth=widthPixel;
